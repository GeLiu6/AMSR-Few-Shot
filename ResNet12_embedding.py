...
class ResNet(nn.Module):
    ...
    def __init__(self, block, keep_prob=1.0, flatten=False, drop_rate=0.0, dropblock_size=5):
        self.inplanes = 3
...
def resnet12(keep_prob=1.0, flatten=True, **kwargs):
    """Constructs a ResNet-12 model.
    """
    model = ResNet(BasicBlock, keep_prob=keep_prob, flatten=flatten, **kwargs)
    return model
